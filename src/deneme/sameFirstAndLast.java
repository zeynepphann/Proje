...
public class sameFirstAndLast {
    ...
    */
    ...
    Bir int array verildiğinde, array uzunluğu 1 veya daha fazlaysa ve ilk öğe ile
    son öğe eşitse true değerini yazdırın.
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Array elemabları gir");
        ...
        System.out.println("useThisArray nin uzunluğu: "+useThisArray.length);
        // code start here
